...
Para comparar esses algoritmos foi calculado a raiz erro quadrático médio (RMSE) que é a diferença entre os valores (amostra ou população) previstos por um modelo ou um estimador e os valores observados. Durante os testes o Gradient Boosting Regressor obteve o melhor.
